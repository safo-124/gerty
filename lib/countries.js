// Full ISO 3166-1 alpha-2 list (common/UN members and territories)
// Source basis: ISO 3166-1 alpha-2. Keep codes uppercase.
...
export function countryCodeToFlagEmoji(code) {
  ...
  const A = 0x1f1e6; // regional symbol for 'A'
